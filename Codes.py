...
API_URL          = os.getenv("API_URL", "http://203.57.85.87")
...
def get_support_keyboard():
    keyboard = [
        [InlineKeyboardButton("👑 𝗢𝗪𝗡𝗘𝗥 👑", url="https://t.me/Rockycodes00")],
        [InlineKeyboardButton("📢 𝗙𝗘𝗘𝗗𝗕𝗔𝗖𝗞 📢", url="https://t.me/+pSBv7wyQ2r44MjRl")],
        [InlineKeyboardButton("💰 𝗣𝗥𝗢𝗢𝗙 💰", url="https://t.me/+pSBv7wyQ2r44MjRl")],
    ]
